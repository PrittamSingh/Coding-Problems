...
public class jan14_26 {
    ...
    public static void updateTree(int node, int start, int end, int left, int right, int value, int[] x, int[] coverCount, double[] coveredLength) {
