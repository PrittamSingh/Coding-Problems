...
public class april03_26 {
    ...
    static int countWalls(int[] walls, int L, int R) {
    ...
    static int solve(int[] walls, int[][] roboDist, int[][] range, int i, int prevDir) {
    ...
    public static void main(String[] args) {
        int[] robots = {4}, distance = {3}, walls = {1,10};
