...
public class aug13_26 {
    ...
    static int n;
    static Node[] segTree;
    static Node merge(Node L, Node R, int leftLen, int rightLen){
        Node res = new Node();
    ...
    static void buildSegmentTree(int i, int l, int r, String s){
        if(l == r){
    ...
    static void update(int i, int l, int r, int pos, char ch) {
        if(l == r) {
